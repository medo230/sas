           ...
           <footer>
               ...
               <div class="footer_ele ">
                   ...
                   <div class="footer_links">
                       <h5> احصل على الدعم </h5>
                       <p>مركز المساعدة </p>
                       <p> الدردشة المباشرة </p>
                       <p> تحقق من حالة الطلب </p>
                       <p> الاموال المستردة </p>
                       <p> الابلاغ عن اساءة الاستخدام </p>
                   </div>
                   ...
                   <div class="footer_links">
                       ...
                       <div class="img">
                           <img src="{{ asset('web/img/GooglePlay.png')}}">
                           <img src="{{ asset('web/img/AppStore.png')}}" class="mt-1">
                       ...
                       <div class="icon_social">
                           ...
                           <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                               xmlns="http://www.w3.org/2000/svg">
                               <g clip-path="url(#clip0_945_10153)">
                                   <path
               ...
               <div class="copy_rights">
                   ...
                   <p>
                       ...
                       <svg width="17" height="17  " viewBox="0 0 20 20" fill="none"
                           ...
                           <path
                               d="M12.4993 8.14799C12.4993 8.14799 11.4699 6.6665 9.75425 6.6665C8.03856 6.6665 6.66602 8.14799 6.66602 9.99984C6.66602 11.8517 8.03856 13.3332 9.75425 13.3332C11.4699 13.3332 12.4993 11.8517 12.4993 11.8517"
                               stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                       </svg>
                   </p>
               </div>
